...
class App(QWidget):
    ...
    def on_click_clear_data(self):
        ...
        QMessageBox.about(self, "Title", " Stored data are cleared....")


    @pyqtSlot()
    def on_click_modify_data_model(self):
        QMessageBox.about(self, "Title", " The data modification must obey the modification manual....Otherwise it may lead to run time error...")
